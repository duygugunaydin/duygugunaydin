...
<img height="40" width="40" src="https://www.vhv.rs/dpng/d/256-2563210_sql-programming-language-logo-hd-png-download.png" title="Sql Programming Language Logo, HD Png Download - sql server logo png" alt="Sql Programming Language Logo, HD Png Download - sql server logo png" id="compImg" style="vertical-align: middle;">
